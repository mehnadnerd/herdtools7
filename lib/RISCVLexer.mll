...
(* Extension Zabha*)
    | "amoswap.b" -> AMO (AMOSWAP,Byte,Rlx)
    | "amoadd.b" ->  AMO (AMOADD,Byte,Rlx)
    | "amoand.b" ->  AMO (AMOAND,Byte,Rlx)
    | "amoor.b" ->   AMO (AMOOR,Byte,Rlx)
    | "amoxor.b" ->  AMO (AMOXOR,Byte,Rlx)
    | "amomax.b" ->  AMO (AMOMAX,Byte,Rlx)
    | "amomin.b" ->  AMO (AMOMIN,Byte,Rlx)
    | "amomaxu.b" -> AMO (AMOMAXU,Byte,Rlx)
    | "amominu.b" -> AMO (AMOMINU,Byte,Rlx)
    | "amoswap.h" -> AMO (AMOSWAP,Half,Rlx)
    | "amoadd.h" ->  AMO (AMOADD,Half,Rlx)
    | "amoand.h" ->  AMO (AMOAND,Half,Rlx)
    | "amoor.h" ->   AMO (AMOOR,Half,Rlx)
    | "amoxor.h" ->  AMO (AMOXOR,Half,Rlx)
    | "amomax.h" ->  AMO (AMOMAX,Half,Rlx)
    | "amomin.h" ->  AMO (AMOMIN,Half,Rlx)
    | "amomaxu.h" -> AMO (AMOMAXU,Half,Rlx)
    | "amominu.h" -> AMO (AMOMINU,Half,Rlx)
    | "amoswap.b.aq" -> AMO (AMOSWAP,Byte,Acq)
    | "amoadd.b.aq" ->  AMO (AMOADD,Byte,Acq)
    | "amoand.b.aq" ->  AMO (AMOAND,Byte,Acq)
    | "amoor.b.aq" ->   AMO (AMOOR,Byte,Acq)
    | "amoxor.b.aq" ->  AMO (AMOXOR,Byte,Acq)
    | "amomax.b.aq" ->  AMO (AMOMAX,Byte,Acq)
    | "amomin.b.aq" ->  AMO (AMOMIN,Byte,Acq)
    | "amomaxu.b.aq" -> AMO (AMOMAXU,Byte,Acq)
    | "amominu.b.aq" -> AMO (AMOMINU,Byte,Acq)
    | "amoswap.h.aq" -> AMO (AMOSWAP,Half,Acq)
    | "amoadd.h.aq" ->  AMO (AMOADD,Half,Acq)
    | "amoand.h.aq" ->  AMO (AMOAND,Half,Acq)
    | "amoor.h.aq" ->   AMO (AMOOR,Half,Acq)
    | "amoxor.h.aq" ->  AMO (AMOXOR,Half,Acq)
    | "amomax.h.aq" ->  AMO (AMOMAX,Half,Acq)
    | "amomin.h.aq" ->  AMO (AMOMIN,Half,Acq)
    | "amomaxu.h.aq" -> AMO (AMOMAXU,Half,Acq)
    | "amominu.h.aq" -> AMO (AMOMINU,Half,Acq)
    | "amoswap.b.rl" -> AMO (AMOSWAP,Byte,Rel)
    | "amoadd.b.rl" ->  AMO (AMOADD,Byte,Rel)
    | "amoand.b.rl" ->  AMO (AMOAND,Byte,Rel)
    | "amoor.b.rl" ->   AMO (AMOOR,Byte,Rel)
    | "amoxor.b.rl" ->  AMO (AMOXOR,Byte,Rel)
    | "amomax.b.rl" ->  AMO (AMOMAX,Byte,Rel)
    | "amomin.b.rl" ->  AMO (AMOMIN,Byte,Rel)
    | "amomaxu.b.rl" -> AMO (AMOMAXU,Byte,Rel)
    | "amominu.b.rl" -> AMO (AMOMINU,Byte,Rel)
    | "amoswap.h.rl" -> AMO (AMOSWAP,Half,Rel)
    | "amoadd.h.rl" ->  AMO (AMOADD,Half,Rel)
    | "amoand.h.rl" ->  AMO (AMOAND,Half,Rel)
    | "amoor.h.rl" ->   AMO (AMOOR,Half,Rel)
    | "amoxor.h.rl" ->  AMO (AMOXOR,Half,Rel)
    | "amomax.h.rl" ->  AMO (AMOMAX,Half,Rel)
    | "amomin.h.rl" ->  AMO (AMOMIN,Half,Rel)
    | "amomaxu.h.rl" -> AMO (AMOMAXU,Half,Rel)
    | "amominu.h.rl" -> AMO (AMOMINU,Half,Rel)
    | "amoswap.b.aq.rl" -> AMO (AMOSWAP,Byte,AcqRel)
    | "amoadd.b.aq.rl" ->  AMO (AMOADD,Byte,AcqRel)
    | "amoand.b.aq.rl" ->  AMO (AMOAND,Byte,AcqRel)
    | "amoor.b.aq.rl" ->   AMO (AMOOR,Byte,AcqRel)
    | "amoxor.b.aq.rl" ->  AMO (AMOXOR,Byte,AcqRel)
    | "amomax.b.aq.rl" ->  AMO (AMOMAX,Byte,AcqRel)
    | "amomin.b.aq.rl" ->  AMO (AMOMIN,Byte,AcqRel)
    | "amomaxu.b.aq.rl" -> AMO (AMOMAXU,Byte,AcqRel)
    | "amominu.b.aq.rl" -> AMO (AMOMINU,Byte,AcqRel)
    | "amoswap.h.aq.rl" -> AMO (AMOSWAP,Half,AcqRel)
    | "amoadd.h.aq.rl" ->  AMO (AMOADD,Half,AcqRel)
    | "amoand.h.aq.rl" ->  AMO (AMOAND,Half,AcqRel)
    | "amoor.h.aq.rl" ->   AMO (AMOOR,Half,AcqRel)
    | "amoxor.h.aq.rl" ->  AMO (AMOXOR,Half,AcqRel)
    | "amomax.h.aq.rl" ->  AMO (AMOMAX,Half,AcqRel)
    | "amomin.h.aq.rl" ->  AMO (AMOMIN,Half,AcqRel)
    | "amomaxu.h.aq.rl" -> AMO (AMOMAXU,Half,AcqRel)
    | "amominu.h.aq.rl" ->  AMO (AMOMINU,Half,AcqRel)
...
(*Zacas*)
    | "amocas.w" ->  AMO (AMOCAS,Word,Rlx)
    | "amocas.d" ->  AMO (AMOCAS,Double,Rlx)
    | "amocas.w.aq" ->  AMO (AMOCAS,Word,Acq)
    | "amocas.d.aq" ->  AMO (AMOCAS,Double,Acq)
    | "amocas.w.rl" ->  AMO (AMOCAS,Word,Rel)
    | "amocas.d.rl" ->  AMO (AMOCAS,Double,Rel)
    | "amocas.w.aq.rl" ->  AMO (AMOCAS,Word,AcqRel)
    | "amocas.d.aq.rl" ->  AMO (AMOCAS,Double,AcqRel)
